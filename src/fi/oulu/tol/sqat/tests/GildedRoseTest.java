...
public class GildedRoseTest {
	...
	// Test Aged Brie
	@Test
	public void testupdateQuality_AgedBrie_Quality_2_10() {
		// Arrange
		store.addItem(new Item("Aged Brie", 2, 10) );
		// Act
		GildedRose.updateQuality();
		// Assert
		int quality = GildedRose.getItems().get(0).getQuality();
		String failMessage = "Quality of Aged Brie increases";
		assertEquals(failMessage, 11,quality);
	}
	@Test
	public void testupdateQuality_AgedBrie_Quality_10_50() {
		// Arrange
	...
	@Test
	public void testupdateQuality_AgedBrie_Quality_0_10() {
		// Arrange
	...
	@Test
	public void testupdateQuality_AgedBrie_Quality_0_50() {
		// Arrange
	...
	@Test
	public void testupdateQuality_AgedBrie_Quality_Minus1_20() {
		// Arrange
	...
	@Test
	public void testupdateQuality_AgedBrie_SellIn_2_10() {
		// Arrange
		store.addItem(new Item("Aged Brie", 2, 10) );
		// Act
		GildedRose.updateQuality();
		// Assert
		int sellIn = GildedRose.getItems().get(0).getSellIn();
		String failMessage = "SellIn date decreases";
		assertEquals(failMessage, 1, sellIn);
	}
	@Test
	public void testupdateQuality_AgedBrie_SellIn_1_10() {
		// Arrange
	...
	@Test
	public void testupdateQuality_AgedBrie_SellIn_0_10() {
		// Arrange
		store.addItem(new Item("Aged Brie", 0, 10) );
		// Act
		GildedRose.updateQuality();
	...
	// Test Sulfuras
	@Test
	public void testupdateQuality_Sulfuras_Quality_0_80() {
		// Arrange
	...
	@Test
	public void testupdateQuality_Sulfuras_SellIn_5_80() {
		// Arrange
	...
	@Test
	public void testupdateQuality_Sulfuras_SellIn_0_80() {
		// Arrange
		store.addItem(new Item("Sulfuras, Hand of Ragnaros", 0, 80) );
		// Act
		GildedRose.updateQuality();
	...
	// Test Backstage pass
	@Test
	public void testupdateQuality_Backstage_Quality_15_20() {
		// Arrange
	...
	@Test
	public void testupdateQuality_Backstage_Quality_10_20() {
		// Arrange
		store.addItem(new Item("Backstage passes to a TAFKAL80ETC concert",
				10, 20) );
		// Act
	...
	@Test
	public void testupdateQuality_Backstage_Quality_8_20() {
		// Arrange
		store.addItem(new Item("Backstage passes to a TAFKAL80ETC concert",
				8, 20) );
		// Act
	...
	@Test
	public void testupdateQuality_Backstage_Quality_5_20() {
		// Arrange
		store.addItem(new Item("Backstage passes to a TAFKAL80ETC concert",
				5, 20) );
		// Act
	...
	@Test
	public void testupdateQuality_Backstage_Quality_3_20() {
		// Arrange
		store.addItem(new Item("Backstage passes to a TAFKAL80ETC concert",
				3, 20) );
		// Act
	...
	@Test
	public void testupdateQuality_Backstage_Quality_0_20() {
		// Arrange
		store.addItem(new Item("Backstage passes to a TAFKAL80ETC concert",
				0, 20) );
		// Act
	...
	@Test
	public void testupdateQuality_Backstage_Quality_15_50() {
		// Arrange
		store.addItem(new Item("Backstage passes to a TAFKAL80ETC concert",
				15, 50) );
		// Act
	...
	@Test
	public void testupdateQuality_Backstage_SellIn_5_10() {
		// Arrange
		store.addItem(new Item("Backstage passes to a TAFKAL80ETC concert",
				5, 10) );
		// Act
	...
	// Test Elixir
	@Test
	public void testupdateQuality_Elixir_Quality_2_7() {
		// Arrange
	...
	@Test
	public void testupdateQuality_SellIn_Quality_2_7() {
		// Arrange
		store.addItem(new Item("Elixir of the Mongoose", 2, 7) );
		// Act
		GildedRose.updateQuality();
